...
public class StatusBarOptionPane extends AbstractOptionPane
{
	...
	protected void _init()
	{
		...
		*/
		...
		showCaretWordOffset = new JCheckBox(jEdit.getProperty("options.status.caret.wordOffset", "Show word offset of caret from beginning of file"),
				jEdit.getBooleanProperty("view.status.show-caret-wordOffset", true));
		showCaretWordOffset.setName("showCaretWordOffset");
		showTotalWords = new JCheckBox(jEdit.getProperty("options.status.totalWords", "Show total number of words in file"),
				jEdit.getBooleanProperty("view.status.show-total-words", true));
		showTotalWords.setName("showTotalWords");
		...
		optionsPanel.add(showTotalWords);
	...
	protected void _save()
	{
		...
		jEdit.setBooleanProperty("view.status.show-total-words", showTotalWords.isSelected());
